...
# @exitcode 1 On failure
 create_docker_openvpn(){
    ...
    exec_root mkdir -p /home/udocker/volumes/openvpn
    exec_root chmod 755 /home/udocker/volumes/openvpn
    exec_root chown udocker:udocker /home/udocker/volumes/openvpn
